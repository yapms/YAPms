...
MapLoader.loadPresetMap=function(a,b){CandidateManager.initCandidates();var c=!1;b&&(c=b.enableCongress);"usa/USA_2020_house_cook"===a&&(c=enableCongressContested=!0);fetch("./res/presets/"+a).then(function(d){return d.json()}).then(function(d){alert("GOOD");console.log(d);MapLoader.loadSavedMap(d,{enableCongress:c})}).catch(function(d){alert("TEST");console.error(d)})};
...
MapLoader.loadMap("./res/usa/washington/2020_house.svg",16,.15,"2","proportional","open");break;case "Wisconsin_2020_state_lower":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/wisconsin/2020_house.svg",16,.5,"1","takeall_noedit","open");break;case "USA_presidential_territories":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/usa_presidential_territories.svg",16,.75,"usa_territories_ec","takeall","open");break;case "USA_2020_presidential":PresetLoader.loadPreset("classic");
MapLoader.loadMap("./res/usa/presidential/usa_presidential.svg",16,.75,"usa_ec","takeall","open");break;case "USA_split_maine":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/presidential/usa_1972_presidential.svg",16,.75,"usa_1972_ec","takeall","open");break;case "USA_2020_senate":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/senate/usa_senate.svg",16,1,"1","senatorial","2020");break;case "USA_2022_senate":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/senate/usa_senate.svg",
16,1,"1","senatorial","2022");break;case "USA_2020_governors":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/governors/usa_gubernatorial.svg",16,.75,"1","gubernatorial","2020");break;case "USA_2020_democratic_primary":PresetLoader.loadPreset("democratic primary");MapLoader.loadMap("./res/usa/primary/usa_dem_primary.svg",16,.75,"dem_primary","proportional","open");break;case "USA_2020_republican_primary":PresetLoader.loadPreset("republican primary");MapLoader.loadMap("./res/usa/primary/usa_rep_primary.svg",
16,.75,"rep_primary","proportional","open");break;case "USA_county":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/county/usa_county.svg",16,.075,"1","takeall_noedit","open");break;case "USA_2020_house":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/house/12-2-2019-house.svg",16,.075,"1","takeall_noedit","open",{enableCongress:!0,enableEraser:!0});break;case "USA_2008_house":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/house/usa_congressional_2008.svg",
...
"open");break;case "USA_proportional":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/usa/presidential/usa_no_districts.svg",16,.75,"usa_no_districts_ec","proportional","open");break;case "USA_pre_civilwar":MapLoader.loadMap("./res/usa/presidential/usa_pre_civilwar.svg",16,.75,"usa_pre_civilwar_ec","presidential","open");break;case "Pakistan_national_assembly":PresetLoader.loadPreset("pakistan");MapLoader.loadMap("./res/pak/pakistan_constituencies.svg",16,.02,"1","takeall_noedit","open");
break;case "Argentina_chamber_of_deputies":PresetLoader.loadPreset("argentina");MapLoader.loadMap("./res/arg/argentina_provinces_buenos.svg",16,.75,"argentina_chamber_of_deputies","proportional","open");break;case "India_2019_lok_sabha":PresetLoader.loadPreset("none");MapLoader.loadPresetMap("ind/"+a);break;case "USA_Canada":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/other/usa_canada.svg",16,.01,"1","takeall","open");break;case "Germany_states":PresetLoader.loadPreset("germany");
MapLoader.loadMap("./res/deu/germany.svg",16,1,"1","takeall","open");break;case "Germany_bundestag":PresetLoader.loadPreset("germany");MapLoader.loadMap("./res/deu/germany_constituencies.svg",16,.25,"1","takeall_noedit","open");break;case "France_national_assembly":PresetLoader.loadPreset("france");MapLoader.loadMap("./res/fra/france_constituencies.svg",16,.25,"1","takeall_noedit","open");break;case "Netherlands_provinces":PresetLoader.loadPreset("netherlands");MapLoader.loadMap("./res/nld/netherlands_provinces.svg",
16,.15,"netherlands_provinces","proportional","open");break;case "Netherlands_gemeenten":PresetLoader.loadPreset("netherlands");MapLoader.loadMap("./res/nld/netherlands_gemeenten.svg",16,.15,"1","takeall_noedit","open");break;case "Italy_states":PresetLoader.loadPreset("italy");MapLoader.loadMap("./res/ita/italy.svg",16,1,"1","takeall_noedit","open");break;case "Portugal_assembly_of_the_republic":PresetLoader.loadPreset("portugal");MapLoader.loadMap("./res/prt/portugal_constituencies.svg",16,.25,
"portugal_constituencies","proportional","open");break;case "Poland":PresetLoader.loadPreset("portugal");MapLoader.loadMap("./res/pol/poland_senate.svg",16,.25,"1","takeall_noedit","open");break;case "Spain_congress_of_deputies":PresetLoader.loadPreset("spain");MapLoader.loadMap("./res/esp/spain_constituencies.svg",16,.25,"spain_constituencies","proportional","open");break;case "Sweden_riksdag":PresetLoader.loadPreset("sweden");MapLoader.loadMap("./res/swe/sweden_districts.svg",25,.25,"sweden_riksdag",
"proportional","open");break;case "Turkey_national_assembly":PresetLoader.loadPreset("turkey");MapLoader.loadMap("./res/tur/turkey_provinces.svg",16,.5,"turkey_national_assembly","proportional","open");break;case "India_lok_sabha":PresetLoader.loadPreset("india");MapLoader.loadMap("./res/ind/india_constituencies.svg",16,.1,"1","takeall_noedit","open");break;case "SouthAfrica_national_assembly":PresetLoader.loadPreset("southafrica");MapLoader.loadMap("./res/zaf/south_africa_provinces.svg",25,.25,"south_africa_national_assembly",
"proportional","open");break;case "UnitedKingdom_house_of_commons":PresetLoader.loadPreset("uk");MapLoader.loadMap("./res/ukd/unitedkingdom.svg",16,.075,"1","takeall_noedit","open");break;case "UnitedKingdom_historic_counties":PresetLoader.loadPreset("uk");MapLoader.loadMap("./res/ukd/unitedkingdom_historic_counties.svg",16,.4,"1","takeall","open");break;case "Ukraine":PresetLoader.loadPreset("uk");MapLoader.loadMap("./res/ukr/ukraine.svg",16,.1,"1","takeall_noedit","open");break;case "Ireland_dail_eireann":PresetLoader.loadPreset("ireland");
MapLoader.loadMap("./res/irl/ireland_constituencies_2020.svg",16,.075,"ireland_constituencies","proportional","open");break;case "Canada_provinces":PresetLoader.loadPreset("canada");MapLoader.loadMap("./res/can/canada_states.svg",38,2,"1","takeall","open");break;case "Canada_house_of_commons":PresetLoader.loadPreset("canada");MapLoader.loadMap("./res/can/canada_constituencies.svg",16,.1,"1","takeall_noedit","open");break;case "Australia_house_of_representatives":PresetLoader.loadPreset("australia");
MapLoader.loadMap("./res/aus/australia_constituencies.svg",16,.1,"1","takeall_noedit","open");break;case "Australia_states":PresetLoader.loadPreset("australia");MapLoader.loadMap("./res/aus/australia.svg",16,.075,"1","takeall","open");break;case "Brazil_chamber_of_deputies":PresetLoader.loadPreset("brazil");MapLoader.loadMap("./res/bra/brazil_states.svg",16,50,"brazil_deputies","proportional","open");break;case "Brazil_federal_senate":PresetLoader.loadPreset("brazil");MapLoader.loadMap("./res/bra/brazil_states.svg",
16,50,"3","proportional","open");break;case "Russia_federal_council":PresetLoader.loadPreset("russia");MapLoader.loadMap("./res/rus/russia_federal_subjects.svg",16,.25,"2","proportional","open");break;case "Russia_duma":PresetLoader.loadPreset("russia");MapLoader.loadMap("./res/rus/russia_constituencies.svg",16,.15,"duma","takeall_noedit","open");break;case "Trinidad_Tobago_house_of_representatives":PresetLoader.loadPreset("trinidad_tobago");MapLoader.loadMap("./res/tto/trinidad_tobago_house_of_representatives.svg",
16,.25,"1","takeall_noedit","open");break;case "Switzerland_national_council":PresetLoader.loadPreset("switzerland");MapLoader.loadMap("./res/che/switzerland_cantons.svg",16,.25,"switzerland_national_council","proportional","open");break;case "Switzerland_council_of_states":PresetLoader.loadPreset("switzerland");MapLoader.loadMap("./res/che/switzerland_cantons.svg",16,.25,"switzerland_council_of_states","proportional","open");break;case "EuropeanUnion":PresetLoader.loadPreset("eu");MapLoader.loadMap("./res/eu/eu.svg",
16,.25,"eu_parliament","proportional","open");break;case "World":PresetLoader.loadPreset("classic");MapLoader.loadMap("./res/other/world.svg",38,.25,"1","takeall","open");break;default:PresetLoader.loadPreset("classic"),MapLoader.loadMap("./res/usa_presidential.svg",16,1,"usa_ec","takeall","open")}};
...
MapLoader.loadSavedMap=function(a,b){obj=a;enableCongress=b?b.enableCongress:!1;MapLoader.loadMap(obj.filename,obj.fontsize,obj.strokewidth,obj.dataid,obj.type,obj.year,{enableCongress:enableCongress,onLoad:function(){for(var c in obj.candidates)if("Tossup"!==c){var d=obj.candidates[c];CandidateManager.addCandidate(c,d.solid,d.likely,d.lean,d.tilt)}for(var e in obj.states){c=obj.states[e];d=states.filter(function(n){return n.name===e})[0];var f=0,g="Tossup",h=0,k;for(k in c.delegates){var l=c.delegates[k];
f+=l;l>h?(g=k,h=l):l===h&&(g="Tossup")}d.setVoteCount(f);"Tossup"===g?d.setColor(g,2):d.setColor(g,c.colorvalue);c.candidate?(d.setColor(c.candidate,c.colorvalue),"proportional"===obj.type&&(d.delegates=c.delegates)):d.delegates=c.delegates;d.simulator=c.simulator;c.disabled&&d.toggleDisable()}for(e in obj.proportional){c=obj.proportional[e];d=proportionalStates.filter(function(n){return n.name===e})[0];f=0;g="Tossup";h=0;for(k in c.delegates)l=c.delegates[k],f+=l,l>h?(g=k,h=l):l===h&&(g="Tossup");
d.setVoteCount(f);"Tossup"===g?d.setColor(g,2):d.setColor(g,c.colorvalue);d.simulator=c.simulator;d.delegates=c.delegates;c.disabled&&d.toggleDisable()}countVotes();ChartManager.updateChart();LegendManager.updateLegend();document.getElementById("map-div").style.visibility="visible"}})};MapLoader.loadFileMap=function(){var a=document.getElementById("loadfile").files[0],b=new FileReader;b.onload=function(c){MapLoader.loadSavedMap(JSON.parse(c.target.result));closeAllPopups()};b.readAsText(a,"UTF-8")};
...
("undefined"!==typeof b.childNodes[1]?b.childNodes[1].innerHTML=" "+a:b.childNodes[0].innerHTML=this.name+" "+a)};State.prototype.getHtml=function(){return this.htmlElement};State.prototype.getDisplayColor=function(){return this.htmlElement.style.fill};State.prototype.setDisplayColor=function(a){this.htmlElement.style.fill=a;var b=document.getElementById(this.name+"-button");null!==b&&(b.style.fill=a);b=document.getElementById(this.name+"-land");null!==b&&(b.style.fill=a)};
State.prototype.verifyTossupColor=function(){"Tossup"===this.candidate&&this.setDisplayColor(CandidateManager.TOSSUP.colors[2])};
...
function setMode(a){console.log("mode "+mode+" | set "+a+" | mapType "+MapLoader.save_type+" | mapYear "+MapLoader.save_year);LogoManager.loadButtons();console.log("allowed");mode=a;document.getElementById("modesbutton");for(var b=document.getElementsByClassName("mode-button"),c=0;c<b.length;++c){var d=b[c];d&&(d.style.opacity="1")}"paint"===a?(d=document.getElementById("modebutton-paint"),d.style.opacity="0.5"):"ec"===a?(d=document.getElementById("modebutton-ec"),d.style.opacity="0.5"):"delete"===
a?(d=document.getElementById("modebutton-delete"),d.style.opacity="0.5"):"fill"===a?(d=document.getElementById("modebutton-fill"),d.style.opacity="0.5"):"highlight"===a&&(d=document.getElementById("modebutton-highlight"),d.style.opacity="0.5")}function verifyPaintIndex(){"undefined"===typeof CandidateManager.candidates[paintIndex]&&(paintIndex="Tossup")}
function countVotes(){var a=document.getElementById("battlechartmid");a&&a.setAttribute("fill",CandidateManager.TOSSUP.colors[2]);for(var b in CandidateManager.candidates){var c=CandidateManager.candidates[b];c.voteCount=0;c.probVoteCounts=[0,0,0,0];for(var d=0,e=states.length;d<e;++d){var f=states[d];"undefined"===typeof f.delegates&&(f.delegates={});"undefined"===typeof f.delegates[b]&&(f.delegates[b]=0);c.voteCount+=f.delegates[b];"Tossup"===f.candidate&&"Tossup"!==b?c.probVoteCounts[0]+=f.delegates[b]:
c.probVoteCounts[f.colorValue]+=f.delegates[b]}d=0;for(e=proportionalStates.length;d<e;++d)f=proportionalStates[d],"undefined"===typeof f.delegates&&(f.delegates={}),"undefined"===typeof f.delegates[b]&&(f.delegates[b]=0,"Tossup"===b&&(f.delegates[b]=f.voteCount)),c.voteCount+=f.delegates[b],"Tossup"===f.candidate&&"Tossup"!==b?c.probVoteCounts[0]+=f.delegates[b]:c.probVoteCounts[f.colorValue]+=f.delegates[b];a&&c.voteCount>Math.ceil(totalVotes/2)&&("Tossup"===b?a.setAttribute("fill",c.colors[2]):
a.setAttribute("fill",c.colors[0]))}}function onResize(){MapManager.centerMap();if("bottom"===ChartManager.chartPosition){var a=document.getElementById("chart-div"),b=document.getElementById("chart");b.style.height="auto";b.style.width=""+(a.offsetHeight-5)+"px"}else document.getElementById("chart-div"),b=document.getElementById("chart"),b.style.height="auto",b.style.width="100%"}
